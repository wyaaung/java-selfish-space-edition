...
public class AstronautMemberTest {
  ...
  @Test
  public void testConstructorExistsAndIsPublic()
  ...
  public void testGameIsGameEngine() throws ClassNotFoundException, NoSuchFieldException {
    Class clazz = Class.forName(FQCN);
    Class tmp = clazz.getDeclaredField("game").getType();
  ...
  public void testActionsIsList() throws ClassNotFoundException, NoSuchFieldException {
    ...
    assertEquals(Class.forName("selfish.deck.Card"), paramType.getActualTypeArguments()[0]);
  }
  ...
  public void testOxygensIsList() throws ClassNotFoundException, NoSuchFieldException {
    ...
    assertTrue(fieldType instanceof ParameterizedType);
    ParameterizedType paramType = (ParameterizedType) fieldType;
    assertEquals(Oxygen, paramType.getActualTypeArguments()[0]);
  }

  @Test
  public void testNameIsString() throws ClassNotFoundException, NoSuchFieldException {
    Class clazz = Class.forName(FQCN);
    Class tmp = clazz.getDeclaredField("name").getType();
  ...
  public void testTrackIsCollection() throws ClassNotFoundException, NoSuchFieldException {
    ...
    assertEquals(Collection.class, field.getType());
    Type fieldType = field.getGenericType();
    assertTrue(fieldType instanceof ParameterizedType);
    ParameterizedType paramType = (ParameterizedType) fieldType;
    assertEquals(Card, paramType.getActualTypeArguments()[0]);
  }
  ...
  public void testAddToTrackIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType("addToTrack", methods, AccessType.PUBLIC));
  }
  ...
  public void testDistanceFromShipIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType("distanceFromShip", methods, AccessType.PUBLIC));
  }

  @Test
  public void testGetActionsIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType("getActions", methods, AccessType.PUBLIC));
  }

  @Test
  public void testGetActionsStrIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType("getActionsStr", methods, AccessType.PUBLIC));
  }
  ...
  public void testGetHandStrIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType("getHandStr", methods, AccessType.PUBLIC));
  }
  ...
  public void testHasMeltedEyeballsIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType(
        "hasMeltedEyeballs", methods, AccessType.PUBLIC));
  }
  ...
  public void testLaserBlastIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType("laserBlast", methods, AccessType.PUBLIC));
  }

  @Test
  public void testOxygenRemainingIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType("oxygenRemaining", methods, AccessType.PUBLIC));
  }

  @Test
  public void testPeekAtTrackIsPublic() {
    assertTrue(
      ClassMemberHelper.methodAccessIsAccessType("peekAtTrack", methods, AccessType.PUBLIC));
  }
  ...
  @Test
  public void testDistanceFromShipReturnsInt()
    throws ClassNotFoundException, NoSuchMethodException {
    Class clazz = Class.forName(FQCN);
  ...
  @Test
  public void testGetActionsStrReturnsString()
    throws ClassNotFoundException, NoSuchMethodException {
    Class clazz = Class.forName(FQCN);
  ...
  @Test
  public void testHackStringParamReturnsCard()
    throws ClassNotFoundException, NoSuchMethodException {
    Class clazz = Class.forName(FQCN);
  ...
  @Test
  public void testHasMeltedEyeballsReturnsBoolean()
    throws ClassNotFoundException, NoSuchMethodException {
    Class clazz = Class.forName(FQCN);
